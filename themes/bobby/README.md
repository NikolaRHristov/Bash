...
- **Light Gray**: Forms the main structure of the prompt, displaying time, user,
...
- **SCM Themes**: Customized themes for source control management (SCM) prompts,
  displaying indicators for dirty and clean states.
...
- **Battery Status**: Includes a battery function to show battery status in the
  prompt.
