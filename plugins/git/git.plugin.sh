...
alias gwip='command git add -A; command git rm $(git ls-files --deleted) 2> /dev/null; command git ecommit --no-verify --no-gpg-sign --message "--wip-- [skip ci]"'
...
alias gc!='command git ecommit --verbose --amend'
alias gc='command git ecommit --verbose'
alias gca!='command git ecommit --verbose --all --amend'
alias gca='command git ecommit --verbose --all'
alias gcam='command git ecommit --all --message'
alias gcan!='command git ecommit --verbose --all --no-edit --amend'
alias gcans!='command git ecommit --verbose --all --signoff --no-edit --amend'
alias gcas='command git ecommit --all --signoff'
alias gcasm='command git ecommit --all --signoff --message'
alias gcmsg='command git ecommit --message'
alias gcn!='command git ecommit --verbose --no-edit --amend'
alias gcs='command git ecommit --gpg-sign'
alias gcsm='command git ecommit --signoff --message'
alias gcss='command git ecommit --gpg-sign --signoff'
alias gcssm='command git ecommit --gpg-sign --signoff --message'
